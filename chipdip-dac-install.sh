...
sudo cp ChipDip-DAC-driver-Volumio2-RPI-4/snd-soc-chipdip-dac-4.19.188-v71+.ko /lib/modules/`uname -r`/kernel/sound/soc/bcm/snd-soc-chipdip-dac.ko
sudo cp ChipDip-DAC-driver-Volumio2-RPI-4/chipdip-dac.dtbo /boot/overlays/chipdip-dac.dtbo
sudo depmod
